...
import static com.example.javacoffee.smartfocus.api.RxTools.RxDataTool.bytes2HexString;
import static com.example.javacoffee.smartfocus.api.RxTools.RxDataTool.hexString2Bytes;
...
public class RxEncryptTool {
     ...
     */
    public static byte[] DESTemplet(byte[] data, byte[] key, String algorithm, String transformation, boolean
            isEncrypt) {
        try {
